...
object CollectionEventCommands {
  ...
  trait CollectionEventModifyCommand extends CollectionEventCommand with HasIdentity with HasExpectedVersion

  final case class AddCollectionEventCmd(
  ...
  final case class UpdateCollectionEventVisitNumberCmd(
      sessionUserId:   String,
      id:              String,
  ...
  final case class UpdateCollectionEventTimeCompletedCmd(
      sessionUserId:   String,
      id:              String,
      expectedVersion: Long,
      timeCompleted:   OffsetDateTime)
  ...
  final case class CollectionEventUpdateAnnotationCmd(
      sessionUserId:    String,
      id:               String,
      expectedVersion:  Long,
  ...
  final case class RemoveCollectionEventAnnotationCmd(
      sessionUserId:    String,
      id:               String,
      expectedVersion:  Long,
      annotationTypeId: String)
  ...
  final case class RemoveCollectionEventCmd(
      sessionUserId:   String,
      id:              String,
      participantId:   String,
      expectedVersion: Long)
