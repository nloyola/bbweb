...
object BbpspTestData {
  ...
  val CollectionSpecimenDefinitions: Set[CollectionSpecimenDefinition] =
    Set(
      CollectionSpecimenDefinition(id                      = SpecimenDefinitionId(SpecimenDefHashids.encode(1)),
                                   slug                    = Slug(""),
                                   ...
                                   amount                  = 10.0),
      CollectionSpecimenDefinition(id                      = SpecimenDefinitionId(SpecimenDefHashids.encode(2)),
                                   slug                    = Slug(""),
                                   ...
                                   maxCount                = 1,
                                   amount                  = 10.0),
      CollectionSpecimenDefinition(id                      = SpecimenDefinitionId(SpecimenDefHashids.encode(3)),
                                   slug                    = Slug(""),
                                   ...
                                   maxCount                = 1,
                                   amount                  = 3),
      CollectionSpecimenDefinition(id                      = SpecimenDefinitionId(SpecimenDefHashids.encode(4)),
                                   slug                    = Slug(""),
                                   ...
                                   maxCount                = 1,
                                   amount                  = 4),
      CollectionSpecimenDefinition(id                      = SpecimenDefinitionId(SpecimenDefHashids.encode(5)),
                                   slug                    = Slug(""),
                                   ...
                                   maxCount                = 1,
                                   amount                  = 9),
      CollectionSpecimenDefinition(id                      = SpecimenDefinitionId(SpecimenDefHashids.encode(6)),
                                   slug                    = Slug(""),
                                   name                    = "Urine cup",
                                   description             = None,
                                   units                   = "mL",
  ...
  val EventTypeAnnotationTypes: Set[AnnotationType] =
    Set(
      AnnotationType(id            = AnnotationTypeId(EventTypeAnnotationTypeHashids.encode(1)),
                     ...
                     required      = true),
      AnnotationType(id            = AnnotationTypeId(EventTypeAnnotationTypeHashids.encode(2)),
                     slug          = Slug("Consent"),
                     name          = "Consent",
                     description   = None,
  ...
  val ProcessingTypeAnnotationTypes: Set[AnnotationType] =
    Set(
      AnnotationType(id            = AnnotationTypeId(EventTypeAnnotationTypeHashids.encode(3)),
  ...
  val ParticipantAnnotationTypes: Set[AnnotationType] =
    Set(
      AnnotationType(id            = AnnotationTypeId(ParticipantAnnotationTypeHashids.encode(1)),
                     slug          = Slug(""),
                     name          = "Date of birth",
                     description   = None,
                     ...
                     options       = Seq.empty[String],
                     required      = true),
      AnnotationType(id            = AnnotationTypeId(ParticipantAnnotationTypeHashids.encode(2)),
                     slug          = Slug(""),
                     name          = "Gender",
                     description   = None,
                     valueType     = AnnotationValueType.Select,
            ...
            if (index == 0)
              InputSpecimenProcessing(expectedChange  = BigDecimal(1.0),
                                      ...
                                      specimenDefinitionId =
                                        SpecimenDefinitionId(SpecimenDefHashids.encode(1L)))
            else
              InputSpecimenProcessing(expectedChange  = BigDecimal(1.0),
                                      count           = 1,
                                      containerTypeId = None,
  ...
  private def createCeventData(participant: Participant): List[CollectionEventData] = {
    ...
    BbpspTestData.EventTypeNames.zipWithIndex.map {
      case (eventTypeName, eventTypeIndex) =>
        ...
        val id =
          CollectionEventId(BbpspTestData.EventHashids.encode((reverseHash :+ eventTypeIndex.toLong): _*))
      ...
      BbpspTestData.CentreNames.zipWithIndex.flatMap {
        case (centreName, centreIndex) =>
          ...
          BbpspTestData.CollectionSpecimenDefinitions.zipWithIndex
            .map {
              case (specimenDefinition, specimenIndex) =>
