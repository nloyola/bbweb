...
object EventUtils {
  ...
  def annotationTypeToEvent(annotationType: AnnotationType): EventAnnotationType =
    EventAnnotationType().update(_.id                    := annotationType.id.id,
  ...
  def annotationTypeFromEvent(event: EventAnnotationType): AnnotationType =
    AnnotationType(id            = AnnotationTypeId(event.getId),
  ...
  def annotationToEvent(
      annotation: org.biobank.domain.annotations.Annotation
    ): org.biobank.infrastructure.events.CommonEvents.Annotation =
    org.biobank.infrastructure.events.CommonEvents
      .Annotation().update(_.annotationTypeId    := annotation.annotationTypeId.id,
  ...
  def annotationFromEvent(
      event: org.biobank.infrastructure.events.CommonEvents.Annotation
    ): org.biobank.domain.annotations.Annotation =
    org.biobank.domain.annotations.Annotation(annotationTypeId = AnnotationTypeId(event.getAnnotationTypeId),
                                              valueType        = AnnotationValueType.withName(event.getValueType),
