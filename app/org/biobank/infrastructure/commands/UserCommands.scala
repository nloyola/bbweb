...
object UserCommands {
  ...
  final case class RegisterUserCmd(name: String, email: String, password: String, avatarUrl: Option[String])
      extends UserCommand

  final case class UpdateUserNameCmd(sessionUserId: String, id: String, expectedVersion: Long, name: String)
      extends UserModifyCommand

  final case class UpdateUserEmailCmd(sessionUserId: String, id: String, expectedVersion: Long, email: String)
      extends UserModifyCommand

  final case class UpdateUserPasswordCmd(
  ...
  final case class UpdateUserAvatarUrlCmd(
      sessionUserId:   String,
      id:              String,
      expectedVersion: Long,
  ...
  final case class UpdateUserAddRoleCmd(
      sessionUserId:   String,
      id:              String,
      expectedVersion: Long,
      roleId:          String)
  ...
  final case class UpdateUserRemoveRoleCmd(
      sessionUserId:   String,
      id:              String,
      expectedVersion: Long,
      roleId:          String)
  ...
  final case class UpdateUserAddMembershipCmd(
      sessionUserId:   String,
      id:              String,
      expectedVersion: Long,
      membershipId:    String)
  ...
  final case class UpdateUserRemoveMembershipCmd(
      sessionUserId:   String,
      id:              String,
      expectedVersion: Long,
      membershipId:    String)
  ...
  final case class ActivateUserCmd(sessionUserId: String, id: String, expectedVersion: Long)
      extends UserStateChangeCommand

  final case class LockUserCmd(sessionUserId: String, id: String, expectedVersion: Long)
      extends UserStateChangeCommand

  final case class UnlockUserCmd(sessionUserId: String, id: String, expectedVersion: Long)
      extends UserStateChangeCommand
