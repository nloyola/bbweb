...
object SpecimenCommands {
  ...
  trait SpecimenModifyCommand extends SpecimenCommand with HasIdentity with HasExpectedVersion

  final case class SpecimenInfo(
      inventoryId:          String,
  ...
  final case class AddSpecimensCmd(
      sessionUserId:     String,
      collectionEventId: String,
      specimenData:      List[SpecimenInfo])
      extends SpecimenCommand

  final case class MoveSpecimensCmd(
      sessionUserId:     String,
      collectionEventId: String,
  ...
  final case class SpecimenAssignPositionCmd(
      sessionUserId:     String,
      id:                String,
      collectionEventId: String,
      expectedVersion:   Long,
      positionId:        Option[String])
      extends SpecimenModifyCommand with HasIdentity

  final case class SpecimenRemoveAmountCmd(
      sessionUserId:     String,
      id:                String,
      collectionEventId: String,
      expectedVersion:   Long,
  ...
  final case class SpecimenUpdateUsableCmd(
      sessionUserId:     String,
      id:                String,
      collectionEventId: String,
      expectedVersion:   Long,
  ...
  final case class RemoveSpecimenCmd(
      sessionUserId:     String,
      id:                String,
      collectionEventId: String,
      expectedVersion:   Long)
