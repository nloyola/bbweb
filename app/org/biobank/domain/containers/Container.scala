...
sealed trait Container
    extends ConcurrencySafeEntity[ContainerId] with HasSlug with HasContainerSchemaPosition
...
object StorageContainer extends ContainerValidations {
  ...
  def create(
    ...
    (Container
      .validate(id, version, inventoryId, label, containerTypeId, sharedProperties, parentId, position) |@|
